...
func newResource(db *gorm.DB, opts ...gen.DOOption) resource {
	...
	_resource.PlatformID = field.NewUint(tableName, "platform_id")
	_resource.Name = field.NewString(tableName, "name")
	_resource.Type = field.NewString(tableName, "type")
	_resource.Details = field.NewString(tableName, "details")
...
func (r *resource) updateTableName(table string) *resource {
	...
	r.Details = field.NewString(table, "details")
...
type IResourceDo interface {
	...
	FindByPlatformID(platformID uint) (result []model.Resource, err error)
	FindByType(resourceType string) (result []model.Resource, err error)
}

// SELECT * FROM @@table WHERE platform_id = @platformID
func (r resourceDo) FindByPlatformID(platformID uint) (result []model.Resource, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, platformID)
	generateSQL.WriteString("SELECT * FROM resources WHERE platform_id = ? ")
...
func (r resourceDo) FindByType(resourceType string) (result []model.Resource, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, resourceType)
	generateSQL.WriteString("SELECT * FROM resources WHERE type = ? ")

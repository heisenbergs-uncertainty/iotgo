...
func newApiKey(db *gorm.DB, opts ...gen.DOOption) apiKey {
	...
	_apiKey.KeyID = field.NewString(tableName, "key_id")
	...
	_apiKey.User = apiKeyBelongsToUser{
		...
		UserInteractions: struct {
			...
			RelationField: field.NewRelation("User.UserInteractions", "model.UserInteraction"),
		},
		ApiKeys: struct {
			field.RelationField
			User struct {
			...
			RelationField: field.NewRelation("User.ApiKeys", "model.ApiKey"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("User.ApiKeys.User", "model.User"),
			},
		},
	}
...
func (a *apiKey) updateTableName(table string) *apiKey {
	...
	a.KeyID = field.NewString(table, "key_id")

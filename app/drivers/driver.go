...
type PlatformDriver interface {
	...
	// FetchData retrieves data from the platform for a specific device.
	// The deviceAlias is used to identify the device on the platform.

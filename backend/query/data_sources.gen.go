...
func newDataSource(db *gorm.DB, opts ...gen.DOOption) dataSource {
	...
	_dataSource.ID = field.NewUint(tableName, "id")
	...
	_dataSource.SourceType = field.NewString(tableName, "source_type")
	_dataSource.ConnectionDetails = field.NewString(tableName, "connection_details")
...
func (d dataSource) Columns(cols ...field.Expr) gen.Columns { return d.dataSourceDo.Columns(cols...) }
...
type IDataSourceDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.DataSource, err error)
	GetByID(id int) (result model.DataSource, err error)
	GetByRoles(rolesName []string) (result []*model.DataSource, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (d dataSourceDo) FilterWithNameAndRole(name string, role string) (result []model.DataSource, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM data_sources WHERE name = ? ")
	if role != "" {
...
func (d dataSourceDo) GetByID(id int) (result model.DataSource, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM data_sources WHERE id=? ")
...
func (d dataSourceDo) GetByRoles(rolesName []string) (result []*model.DataSource, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, rolesName)
	generateSQL.WriteString("SELECT * FROM data_sources WHERE role IN ? ")

...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.HashedPassword = field.NewBytes(tableName, "hashed_password")
...
func (u *user) updateTableName(table string) *user {
	...
	u.HashedPassword = field.NewBytes(table, "hashed_password")
...
type IUserDo interface {
	...
	GetByRoles(rolesName []string) (result []*model.User, err error)
}
...
func (u userDo) GetByRoles(rolesName []string) (result []*model.User, err error) {
	var params []interface{}
